...
export async function dropAllCollectionsFromDatabase(mongooseInstance: typeof mongoose): Promise<void> {
...
export async function dropDatabase(mongooseInstance: typeof mongoose): Promise<void> {
    await mongooseInstance.connection.db.dropDatabase();
}

export async function disconnect(mongooseInstance: typeof mongoose): Promise<void> {

...
import { CassandraMethods, CassandraTableNames} from "../../Constants/cassandra_constants";
...
export class CassandraDatabaseQueries{
   ...
   readConfession=(confessionModel:ConfessionModel):void=>{
    try{
        ...
        const {PARTITION_KEY, FIRST_SORTING_KEY, SECOND_SORTING_KEY}=CassandraMethods.getRecievedUnreadConfessionsKey()
        this.client.execute(

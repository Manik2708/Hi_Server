...
import { convertUpdateConfessionStatusToCommonMessage, covertConfessionToCommonMessage } from "src/Models/message_handler";
...
import { UpdateConfessionStatus, UpdateConfessionStatusForSender } from "src/Models/update_status_of_confession";
...
export class ConfessionServices{
    ...
    sendConfessionToUser=async(req: express.Request, res: express.Response)=>{
        try {
            const {
              senderId,
              senderAnonymousId,
